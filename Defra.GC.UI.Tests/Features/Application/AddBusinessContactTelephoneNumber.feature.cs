...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("test", "England", "01632 960 001", "Sign up", null)]
        public void AddContactTelephoneNumber(string logininfo, string country, string telephoneNumber, string nextPage, string[] exampleTags)
        {
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("test", "England", "abc123", "Enter a telephone number in the correct format", null)]
        public void VerifyErrorMessageForInvalidContactTelephoneNumber(string logininfo, string country, string telephoneNumber, string errorMessage, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("logininfo", logininfo);
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("test", "England", "", "Enter the phone number of the contact person", null)]
        public void VerifyErrorMessageForBlankContactTelephoneNumber(string logininfo, string country, string telephoneNumber, string errorMessage, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("logininfo", logininfo);
...
#line hidden
        ...
        public void VerifyBackLinkOnContactTelephoneNumberPage(string logininfo, string country, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("logininfo", logininfo);
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("test", "England", null)]
        public void VerifySaveAndContinueLaterOnContactTelephoneNumberPage(string logininfo, string country, string[] exampleTags)
        {
