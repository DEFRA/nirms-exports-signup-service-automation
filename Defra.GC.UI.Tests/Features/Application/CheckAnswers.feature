...
Scenario: Check answers and submit sign up link verification on NI points of establishment
	...
	Examples: 
	| logininfo | Business selection       | Country          | FBONumber | Business name | AddressLine | Town    | AddrPostcode | contactName | contactPosition | emailAddress  | telephoneNumber | EstablishmentName | AddressLine1 | estCity | estCountry       | FieldName                                  | FieldValue          |
	| test4     | NORTH WEST TELUGU SANGAM | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName21     | testAddress1 | Belfast | Northern Ireland | FBO number                                 | ChangeFBO           |
	| test4     | NORTH WEST TELUGU SANGAM | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName22     | testAddress1 | Belfast | Northern Ireland | Contact name                               | ChangedName         |
	| test4     | NORTH WEST TELUGU SANGAM | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName23     | testAddress1 | Belfast | Northern Ireland | Contact position                           | ChangedPosition     |
	| test5     | SND NON UK User          | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName24     | testAddress1 | Belfast | Northern Ireland | Contact email address                      | change@test.com     |
	| test5     | SND NON UK User          | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName25     | testAddress1 | Belfast | Northern Ireland | Contact telephone number                   | 01632 960 999       |
	| test5     | SND NON UK User          | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName26     | testAddress1 | Belfast | Northern Ireland | Address                                    | ChangedAddress      |
	| test5     | SND NON UK User          | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName27     | testAddress1 | Belfast | Northern Ireland | Email address                                   | Changed@Address.com |
	| test5     | SND NON UK User          | Northern Ireland | testFBO   | testName      | testAddress | Belfast | BT29 9AJ     | contactName | contactPosition | test@test.com | 01234 234 455   | testEstName28     | testAddress1 | Belfast | Northern Ireland | Contact person is the authorised representative | No                  |
