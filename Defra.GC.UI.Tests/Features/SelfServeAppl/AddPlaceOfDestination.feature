...
Scenario: Verify Add Place Of Destination link
	...
	| test1C    | Tesco York         | Northern Ireland Retail Movement Scheme | Add a place of destination | You do not need to add an establishment that | testName11        | testAddress1 | testCity1 | Northern Ireland | BT30 6LZ     | testName12         | testAddress2 | testCity2 | Northern Ireland | BT52 2AJ      |
...
Scenario: Verify zero results page on Place Of Destination page
	...
	| test1C    | Tesco York         | Add a place of destination | BT43 4TT     | 0 results    |
...
Scenario: Verify error messages for place of destination mandatory fields
	...
	| test      |	 Tesco York        | BT93 8AD |                   | testAddress1 | testCity   | testCountry | BT93 8AD     | Enter an establishment name                      |
	| test      |    Tesco York		   | BT93 8AD | testErrorName1    |              | testCity   | testCountry | BT93 8AD     | Enter address line 1                             |
	| test      |    Tesco York        | BT93 8AD | testErrorName2    | testAddress1 |            | testCountry | BT93 8AD     | Enter a town or city                             |
	| test      |    Tesco York		   | BT93 8AD | testErrorName3    | testAddress1 | testCity   | testCountry |              | Enter a postcode                                 |
	| test      |    Tesco York        | BT93 8AD | testErrorName4$%  | testAddress1 | testCity   | testCountry | BT93 8AD     | Enter an establishment name using only letters, numbers, brackets, full stops, hyphens, underscores, forward slashes, apostrophes or ampersands |
	| test      |    Tesco York		   | BT93 8AD | testErrorName5    | testAddr%$   | testCity   | testCountry | BT93 8AD     | Enter address line 1 using only letters, numbers, brackets, full stops, hyphens, underscores, forward slashes, apostrophes or ampersands     |
	| test      |    Tesco York        | BT93 8AD | testErrorName6    | testAddress1 | testCity%$ | testCountry | BT93 8AD     | Enter a town or city using only letters, numbers, brackets, full stops, hyphens, underscores, forward slashes, apostrophes or ampersands     |
	| test      |    Tesco York        | BT93 8AD | testErrorName7    | testAddress1 | testCity   | testCountry | BT93 8AD$%   | Enter a real postcode                            |
...
Scenario: Verify validation error message for blank Destination Establishment postcode field and non NI postcode
	...
	| test1A    | Tesco York         |           | Enter a postcode. |
	| test1A    | Tesco York         | wd19 7pf  | Enter a postcode in Northern Ireland |