...
#line hidden
#line 14
 testRunner.And(string.Format("verify status \'NOT SIGNED-UP\' and link \'Sign up\' is displayed for the \'{0}\' on se" +
                            "lf serve dashboard", businessSelection), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 15
...
#line hidden
#line 17
 testRunner.And(string.Format("verify status \'SIGN-UP STARTED\' and link \'Continue\' is displayed for the \'{0}\' on" +
                            " self serve dashboard", businessSelection), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
 testRunner.And(string.Format("select business \'{0}\' on self serve dashboard", businessSelection), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
