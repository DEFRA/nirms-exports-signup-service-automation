...
namespace Defra.Trade.ReMos.AssuranceService.Tests.Pages
{
    public class PointOfDepartureEstablishmentPage : IPointOfDepartureEstablishmentPage
    {
        ...
        private IWebElement EstablishmentEmailAddress => _driver.WaitForElement(By.Id("Email"));
        private IWebElement Continue => _driver.WaitForElement(By.XPath("//button[contains(text(),'Continue')] | //button[contains(text(),'Save and continue')]"));
        ...
        public void ClickOnSelectAddressButton()
        {
            ...
            s.SelectByIndex(0);
            IJavaScriptExecutor jsExecutor1 = (IJavaScriptExecutor)_driver;
            jsExecutor1.ExecuteScript("arguments[0].click();", SelectAddresButton);
