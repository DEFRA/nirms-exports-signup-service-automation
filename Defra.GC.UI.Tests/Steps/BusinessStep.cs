...
namespace Defra.Trade.ReMos.AssuranceService.Tests.Steps
{
    ...
    public class BusinessStep
    {
        ...
        //        [When(@"user enters manually all address fields  '([^']*)'<AddressLine(.*)>'([^']*)'<Town>'([^']*)'<AddrPostcode>'")]
        //        public void WhenUserEntersManuallyAllAddressFieldsAddressLineTownAddrPostcode(string p0, int p1, string p2, string p3)
        //        {
        //        }
